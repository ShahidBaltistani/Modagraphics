(function () {
    ...
    angular
        .module('app')
        .controller('JobList_Log', JobList_Log);

    JobList_Log.$inject = ['$scope', 'com'];

    function JobList_Log($scope, com) {
        var step = 4;
        $scope.maxSize = 6;
        $scope.totalCount = 0;
        $scope.pageIndex = 1;
        ...
        $scope.getProjectList = function () {
            ...
            com.post("/Installer/GetJobDetail", obj).then(function (result) {
                debugger
        ...
        $scope.ViewLogs = function (Id) {
            debugger
            com.get('/Logs/ViewJobLogDetailForInstaller/' + Id).then(function (result) {
                debugger
