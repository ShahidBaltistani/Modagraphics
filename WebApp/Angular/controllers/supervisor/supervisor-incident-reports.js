(function () {
    ...
    angular
        .module('app')
        .controller('supervisor_incidentReport', supervisor_incidentReport);
    ...
    function supervisor_incidentReport($scope, com) {
        ...
        $scope.getIncidentReports = function () {
            ...
            ////debugger;
            com.post("/Supervisor/IncidentReportList", obj).then(function (result) {
        ...
        {
            com.get('/Supervisor/ApproveJob/' + id).then(function () {
        ...
        {
            com.get('/Supervisor/SentForRepair/' + id).then(function () {
