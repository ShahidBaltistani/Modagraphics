(function () {
    ...
    angular
        .module('app')
        .controller('SiteList_Log', SiteList_Log);

    SiteList_Log.$inject = ['$scope', 'com'];

    function SiteList_Log($scope, com) {
        var step = 4;
        $scope.maxSize = 6;
        $scope.totalCount = 0;
        $scope.pageIndex = 1;
        ...
        $scope.getProjectList = function () {
            ...
            com.post("/Supervisor/SiteListLog", obj).then(function (result) {
                debugger
