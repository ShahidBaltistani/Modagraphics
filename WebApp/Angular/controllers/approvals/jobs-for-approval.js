    ...
    function approve_job($scope, com) {
        ...
        $scope.getJobs = function () {
            ...
            var obj = {
                ...
                FirstName: $scope.searchModel.installer, // FirstName is used for Installer
                LastName: $scope.searchModel.siteName,   // Lastname is used for sitename
                LPN: $scope.searchModel.LPN,
                VIN: $scope.searchModel.VIN,
                assignDate: $scope.searchModel.assignDate
            };

            com.post("/Approvals/GetJobsWaitingForApproval", obj).then(function (result) {
        ...
        $scope.showImage = function (id) {
            ...
            $scope.jobID = id;
            com.get('/Approvals/GetApprovalImages/' + id).then(function (result) {
        ...
        $scope.ApproveJob = function (id) {
            ...
            ////debugger;
            mApp.blockPage({ message: "Loading..." });
            com.get('/Approvals/ApproveJob/' + id).then(function (result) {
