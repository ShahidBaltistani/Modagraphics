(function () {
    ...
    angular
        .module('app')
        .controller('JobsFleetOwner', JobsFleetOwner);

    JobsFleetOwner.$inject = ['$scope', 'com'];

    function JobsFleetOwner($scope, com) {
        var step = 4;
        $scope.maxSize = 6;
        $scope.totalCount = 0;
        $scope.pageIndex = 1;
       ...
       // $scope.sitesStatus = {};
        ...
        $scope.getProjectList = function () {
            ...
            com.post("/FleetOwner/JobsFleetOwner", obj).then(function (result) {
                debugger
