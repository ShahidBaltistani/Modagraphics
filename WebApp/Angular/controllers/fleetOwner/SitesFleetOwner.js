(function () {
    ...
    angular
        .module('app')
        .controller('SitesFleetOwner', SitesFleetOwner);

    SitesFleetOwner.$inject = ['$scope', 'com'];

    function SitesFleetOwner($scope, com) {
        var step = 4;
        $scope.maxSize = 6;
        $scope.totalCount = 0;
        $scope.pageIndex = 1;
        ...
        $scope.searchModel = { projectName: '', fleetOwnerName: '', siteName: '', po: '', SiteStatus: '3' };
        //$scope.sitesStatus = {};
        ...
        $scope.getProjectList = function () {
            ...
            var obj = {
                ...
                SiteStatus: $scope.searchModel.SiteStatus,
            };
            mApp.blockPage({ message: "Fetching..." });
            com.post("/FleetOwner/SitesFleetOwner", obj).then(function (result) {
                debugger
