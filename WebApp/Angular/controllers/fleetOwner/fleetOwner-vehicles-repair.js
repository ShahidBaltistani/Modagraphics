(function () {
    ...
    angular
        .module('app')
        .controller('fleetOwner_vehiclsToRepair', supervisor_vehiclsToRepair);
    ...
    function supervisor_vehiclsToRepair($scope, com) {
        ...
        $scope.VehiclestoReports= function () {
            ...
            com.post("/FleetOwner/GetVehiclesToRepair", obj).then(function (result) {
        ...
        {
            com.get('/FleetOwner/Repaired/'+ id).then(function (result) {
